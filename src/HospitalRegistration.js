...
<div className="ch-container">
    <div className="row">
        ...
        <div id="content" className="col-sm-12" style={bgClr}>
            ...
            <div className="col-sm-12" style={bgClrF7}>
           <div className="col-sm-3"></div>
                ...
                <form className="form-horizontal " role="form">
                  ...
                  <label for="inputEmail1" className="col-lg-3 control-label ">Hospital Name   :  </label>
                 ...
                 <div className="form-group">
                  <label for="inputEmail1" className="col-lg-3 control-label">Ethinity   :  </label>
                  <div className="col-lg-8">
