                  ...
                  <div className="col-sm-6" >
                        ...
                        <div className="box-inner" style={bgWhite}>
                            ...
                            <div className="box-content" style={min800}>
                                ...
                                <div className="form-group">
                                    <label for="inputEmail1" className="col-lg-3 control-label"> Name   :  </label>
                                 ...
                                 <div className="form-group">
                                    <label for="inputEmail1" className="col-lg-3 control-label">Age   :  </label>
                                    <div className="col-lg-8">
                    ...
                    <span className="input-group-addon">
                        <span className="glyphicon glyphicon-calendar"></span>
                                 ...
                                 <div className="form-group">
                                    <label for="inputEmail1" className="col-lg-3 control-label">Gender   :  </label>
                                    <div className="col-lg-8">
                                    <div className="radio">
                                    <label>
                                 ...
                                 <div className="form-group">
                                    <label for="inputEmail1" className="col-lg-3 control-label">organ needs   :  </label>
                                    <div className="col-lg-8">
                                        <input type="text" className="form-control" id="" placeholder="" />
                                    </div>
                                </div>
                                 <div className="form-group">
                                    <label for="inputEmail1" className="col-lg-3 control-label">Blood group   :  </label>
                                    <div className="col-lg-8">
                                    <select  className="form-control" id=""><option>Please Select</option></select>
                                    </div>
                                </div>
                                 <div className="form-group">
                                    <label for="inputEmail1" className="col-lg-3 control-label">Lab verified   :  </label>
                                 ...
                                 <div className="form-group">
                                    <label for="inputEmail1" className="col-lg-3 control-label">Hospital verified   :  </label>
                                    <div className="col-lg-8">
                                        <span className="checkbox-inline">
                                        <input type="checkbox" id="inlineCheckbox1" value="option1" /> 
                                        </span>
